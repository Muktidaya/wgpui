...
use wgpui_kit::component::{
    Disableable, IndexPath, Root,
    command::{Command, CommandGroup, CommandItem, CommandState},
};
use wgpui_kit::test::{TestSupportExt, TestWindowExt};
use wgpui_kit::{AppContext, Context, Entity, TestAppContext, Window, div, prelude::*, px, size};

wgpui_kit::actions!(search_test, [Save]);
...
fn palette(cx: &mut TestAppContext) -> (wgpui_kit::WindowHandle<Root>, Entity<Palette>) {
...
use wgpui_kit::test::TestAppContextExt;
...
struct Languages {
    ...
    _subscription: wgpui_kit::Subscription,
}
...
fn languages(
    ...
    multiple: bool,
    disabled: bool,
) -> (wgpui_kit::WindowHandle<Root>, Entity<Languages>) {
    cx.update(wgpui_kit::init);
    let mut view = None;
