...
use wgpui_component_assets::{AllAssets, Assets, IconName};
...
wgpui_component_assets::icon_assets!(SelectedAssets, [Search, Check]);
...
wgpui_component_assets::icon_assets!(pub EmptyAssets, []);
