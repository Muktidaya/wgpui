    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        fn button_base(id: impl Into<ElementId>, label: &'static str) -> Stateful<Div> {
            div()
                ...
                .justify_center()
                .items_center()
                .bg(wgpui::rgb(0x2563eb))
                .text_color(wgpui::white())
                .rounded_md()
                .cursor_pointer()
                .hover(|style| style.bg(wgpui::rgb(0x1d4ed8)))
                .child(label)
        }
        ...
        div()
            ...
            .p_8()
            .gap_6()
            .bg(wgpui::rgb(0xf3f4f6))
            .child(
                div()
                    .text_2xl()
                    .font_weight(wgpui::FontWeight::BOLD)
                    .text_color(wgpui::rgb(0x111827))
            ...
            .child(
                div()
                    .p_4()
                    .rounded_md()
                    .bg(wgpui::rgb(0xdbeafe))
                    .text_color(wgpui::rgb(0x1e3a8a))
